...
└── seeds/
    └── demo_seed.sql              ← Premium demo seed (multi-org, realistic scores) — generated by scripts/generate_demo_premium_seed.js
```
...
| File | Purpose |
|------|---------|
| `demo_seed.sql` | Multi-org demo seed with realistic score distributions and workflow-state diversity — generated by `scripts/generate_demo_premium_seed.js` |
...
```bash
node scripts/generate_demo_premium_seed.js
